...
"width = 450, height = 320, resizabla = no, scrollbars = no, status = no");
   }
</script>
...
<div class="wrapper" style="background:white; height: 620px; padding-top: 3%;">
 <div class="joinForm" style="margin-top:3%; margin-left:27%;">
      ...
      <div id="member" style="display:block;margin-top: 15px;">
            <input type="text" placeholder="아이디" class="iText" name="p_id" value="${p_id}" />
            <a href="#" onclick="idCheck()" class="btn"/>중복확인</a> <br/>
            <span id="duplicate" name="check">${pwCheck}</span>
            <input type="password" placeholder="비밀번호" class="iText" name="p_pw" value="${p_pw}" />
            <input type="password" placeholder="비밀번호 확인" class="iText" name="p_pw2" value="${p_pw}"/><br/>
            ...
            <span name="mailCheck" class="checkMail" style="display: none">인증완료</span>
            <a href="#" onclick="insertPopup()">
            <a href="#"  id="mailCheck" onclick="emailSend()" class="btn" disabled/>인증메일 전송하기</a><br/></a>
      ...
      <div id="business" style="display:none;margin-top: 15px;">
            ...
            <a href="#" onclick="idCheck2()" class="btn"/>중복확인</a> <br/>
            <span id="idCheck" name="idCheck">${idCheck}</span>
            <input type="password" placeholder="비밀번호" class="iText" name="p_pw3" value="${p_pw}" />
            <td><input type="password" placeholder="비밀번호 확인" class="iText" name="p_pw4" value="${p_pw}" />
            <span id="duplicate" name="check">${pwCheck}</span><br/>
            ...
            <select name="phone4" id="phone4" style="width:100px; height:32px;">
               ...
               - <input type="text" name="phone5"  class="iText" value="${phone5}"/> - <input type="text"  class="iText" name="phone6" value="${phone6}"/><br/>
            ...
            <span name="mailCheck" class="checkMail" style="display: none">인증완료</span>
            <a href="#" onclick="insertPopup()">
            <a href="#"  id="mailCheck" onclick="emailSend2()" class="btn" disabled/>인증메일 전송하기</a><br/></a>
