...
<input type="hidden" name="cl_code" value=${co.cl_code}>
세탁소이름 <input type="text" name="cl_name" value="${co.cl_name}"/><br/>
주소 ${co.cl_address}<input type="hidden" name="cl_address" value="${co.cl_address}"/>
...
<div id="addressChange" style="display:none">
      ...
      <input type="text" name="addr2" id="sample6_address2" placeholder="상세주소" /> 
         ...
         <br/>
연락처<input type="text" name="cl_phone" value="${co.cl_phone}"/><br/>
운영시간 오픈<br/> <select name="cl_open" id="cl_open">
      ...
      마감 <select name="cl_close" id="cl_close">
         <option value="1">01:00</option>
         <option value="2">02:00</option>
         <option value="3">03:00</option>
         <option value="4">04:00</option>
       ...
       세탁기개수 <input type="text" name="cl_qty" value="${co.cl_qty}"/> 
      ...
      <input type="button" onclick="updateCoinShop()" value="매장수정" />
      </form>
</body>
<script>
var arr = [];
