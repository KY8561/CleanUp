...
<body id="top">
<div class="wrapper row1" style="height: 250px;">
...
<div class="wrapper" style="background-color:white; height: 80%;">
   <div class="loginForm" style="margin-left:28%; ">
    <form name="updateForm" method="post" enctype="multipart/form-data">
        <input type="text" name="nl_name" id="nl_name" value="${nlMap.nl_name }" class="iText"/> </br>
         ${nlMap.nl_address}
...
<div class="wrapper row4" style="border-top-width: 0px;">
  <footer id="footer" class="clear" style="margin-left: 0px; margin-right: 0px; margin-top:5%;">
