...
<div class="wrapper row1" style="height: 300px;">
  <header id="header" class="clear" style="width:92%;"> 
   <a href="./logout" style="float:right;">로그아웃</a><a  href="./personUpdateMV"style="float:right;">개인정보수정　|　</a><br/>
    <div id="logo">
      <img src="resources\bootstrap\images\img_t21_006.jpg" style="margin-left:6%; margin-top:2%; margin-bottom:2%;"/>
    </div>
    <nav id="mainav">
      <ul class="clear">
...
<div class="wrapper" style="background-color:white;" >
  ...
  <div style="margin-bottom:50px; height:450px; " >
   ...
   고객님은 현재 ${grade }등급입니다.<br/>
   혜택 적립포인트  <span id="percent"></span> 적립<br/>
   
   <a href='./PointAdd'>포인트 충전   |</a>
   <a href='./PointReturn'>   포인트 환불</a>
   </div>
   
   <table style="margin-top:10px; width:700px; margin-left:22%;">
      <tr>
         <td><div onclick="point()" style="cursor:pointer">사용가능 적립 포인트</div></td>
         <td><div onclick="mileage()" style="cursor:pointer">사용가능 적립 마일리지</div></td>
      </tr>
      <tr>
         <td>${pointtotal }</td>
         <td>${mileagetotal }</td>
   ...
   <form name="chk">
     <input type="hidden" id="value" name="value"/>
      <select name="type" id="type" onChange="kindchange()" style="width:120px; height:32px; margin-left:22%; color:#63CAC6;">
   ...
   <div >
      <div id="point" style="width:700px; margin-left:22%; margin-top:10px;" >
         ${pointList }
      </div>
      <div id="mileage" style="width:700px; margin-left:22%; margin-top:10px;">
         ${mileageList }
      </div>
  </div>
</div>
