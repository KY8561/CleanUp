...
public ModelAndView execute(int check, int cmd){
   ...
   private String makeBusinessHtml2(List<Person> blist) {
      ...
      sb.append("</table>");
      sb.append("<br/>");
      sb.append("<a href='#' style='float:right' class='btn' onclick='personDelete(2)'>탈퇴시키기</a>");
      return sb.toString();
   }
   ...
   private String makeMemberHtml2(List<Person> blist) {
      ...
      sb.append("</table>");
      sb.append("<br/>");
      sb.append("<a href='#' style='float:right' class='btn' onclick='personDelete(1)'>탈퇴시키기</a>");
      return sb.toString();
   }
   ...
   private String makePersonHtml2(List<Person> blist) {
      ...
      sb.append("</table>");
      sb.append("<br/>");
      sb.append("<a href='#' style='float:right' class='btn' onclick='personDelete(0)'>탈퇴시키기</a>");
      return sb.toString();
   }
   ...
   private String makeBlackHtml(List<Person> blist) {
      ...
      sb.append("</table>");
      sb.append("<br/>");
      sb.append("<a href='#' style='float:right' class='btn' onclick='change(3)'>블랙리스트 추가</a>");
      return sb.toString();
   }
   ...
   private String makeBusinessHtml(List<Person> blist) {
      ...
      sb.append("</table>");
      sb.append("<br/>");
      sb.append("<a href='#' style='float:right' class='btn' onclick='change(2)'>블랙리스트 추가</a>");
      return sb.toString();
   }
   ...
   private String makeMemberHtml(List<Person> blist) {
      ...
      sb.append("</table>");
      sb.append("<br/>");
      sb.append("<a href='#' style='float:right' class='btn' onclick='change(1)'>블랙리스트 추가</a>");
      return sb.toString();
   }
   ...
   private String makePersonHtml(List<Person> blist) {
      ...
      sb.append("</table>");
      sb.append("<br/>");
      sb.append("<a href='#' style='float:right' class='btn' onclick='addBlack()'>블랙리스트 추가</a>");
      return sb.toString();
   }
